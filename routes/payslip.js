...
router.post("/", async (req, res, next) => {
  ...
  if (!body.companyName) {
    ...
    error =
      "Wrong employee earnings values. Values must be array of object. Object like { name: 'Basic', amount: 10000 }";
  } else if (domains.indexOf(body.employeeEmail) !== -1) {
    // validate a temp mail address
